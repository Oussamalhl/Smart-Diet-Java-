...
public class Personne {
    ...
    public Personne(String nom, String prenom, String dateNaissance, String mail, String password, String adresse, int numero, String civilite, String privilege, int nombreLivraison) {
        this.nom = nom;
        this.prenom = prenom;
        this.dateNaissance = dateNaissance;
        this.mail = mail;
